...
- UMS (Users Management Service agent). The Agent to work with users within our system. Capable to search, create, read, update and delete users. Equipped with ability to make search through users within system. Use this agent to check if an asked user exists in the system, to find information about user or to perform any action related to users, or to create new users.
...
- CONTEXT is generated by another agent that got the job done that the user requested
